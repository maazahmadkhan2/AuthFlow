    ...
    const verifyEmail = async () => {
      ...
      try {
        ...
        if (isCustomVerificationCode(actionCode)) {
          ...
          // Update user verification status in Firestore and Firebase Auth
          ...
          // If user is currently logged in and this is their verification
          if (auth.currentUser && auth.currentUser.uid === codeData.uid) {
